...
def build_watcher_outcome(
    ...
    *,
    ...
    return {
        ...
        "account_type": verification.get("account_type") or token.get("account_type") or "",
        "score": _float_or_none(verification.get("score")),
...
def market_snapshot(market: dict, *, checked_at: str) -> dict:
    ...
    return {
        ...
        "volume_m5_usd": _float_or_none(market.get("volume_m5_usd")),
        "volume_h1_usd": _float_or_none(market.get("volume_h1_usd")),
        "volume_h6_usd": _float_or_none(market.get("volume_h6_usd")),
